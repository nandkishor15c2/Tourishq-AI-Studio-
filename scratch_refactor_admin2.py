...
v_about = '{/* VIEW 6: ABOUT US PAGE */}'
v_admin = '{/* VIEW 7: INTERNAL TEAM ADMIN REVENUE & OPERATIONS DASHBOARD */}'
v_end = '</main>'

if v_escalation in content and v_dashboard in content and v_about in content and v_admin in content and v_end in content:
    ...
    dashboard_block = content[idx_dash:idx_about]
    about_block = content[idx_about:idx_admin]
    admin_block = content[idx_admin:idx_end]
...
""")
    ...
    with open(app_path, 'w') as f:
        f.write(new_content)
    print("Success: Extracted Support, Dashboard, About, and Admin Pages.")
else:
